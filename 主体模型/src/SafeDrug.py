...
def main():
    ...
    pretrained_model.load_state_dict(torch.load("saved/SafeDrug/pretrained_model_ja_0.5302.pt", map_location=device))
    ...
    regular = Regularization(model, 0.005, p=0)  # 老师给的正则化模型
    ...
    print(best_model.graph_embeddings.edge_embedding.weight.data)
    # 画ja的图
